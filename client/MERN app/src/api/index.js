...
const events_url = `https://mern-app-uvft.onrender.com/api/events`;

//event posting and getting (?)
export const fetchEvents = (filters, searchQuery, page = 1, limit = 10) =>
...
const auth_url = `https://mern-app-uvft.onrender.com/api/auth`;
...
export const updateProfile = (id, club) =>
  axios.put(`${auth_url}/edit/${id}`, club);
export const changePassword = (id, passwords) =>
  axios.put(`${auth_url}/changePassword/${id}`, passwords);

const clubs_url = `https://mern-app-uvft.onrender.com/api/clubs`;
